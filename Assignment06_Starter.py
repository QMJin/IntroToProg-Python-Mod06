...
# QimingJin,11.10.2019,Modified code to complete assignment 6
# ------------------------------------------------------------------------ #
...
class FileProcessor:
    ...
    @staticmethod
    def WriteListDataToFile(objFile, dicRow, lstTable):
        """
              Desc - Write data from a list of dictionary rows into a local txt file

              :param objFile: object file to write data
              :param list_of_rows: (list) you want filled with file data:
              :return (list) of dictionary rows
              """
...
class IO:
    ...
    def AddItem(dicRow):
        ...
        :param dicRow: rows you want to add
        :return: nothing
        """
    ...
    def RemoveItem(lstTable):
        ...
        :param lstTable: list/table of items
        :return: nothing
        """
...
while(True):
    ...
    # Step 3.2 - Add a new item to the list/Table
        ...
        IO.GetInput()       # Get user input of task and priority
        IO.AddItem(dicRow)      # Add item to the list/Table
        IO.ShowCurrentItemsInList(lstTable)  # Show current data in the list/table
        continue  # to show the menu
    ...
    # Step 3.3 - Remove a new item to the list/Table
        ...
        # Step 3.3.b - Remove item from list/Table
        IO.RemoveItem(lstTable)
        #Step 3.3.c - Show the current items in the table
        IO.ShowCurrentItemsInList(lstTable)  # Show current data in the list/table
        continue  # to show the menu
    ...
    # Step 3.4 - Save tasks to the ToDoFile.txt file
        ...
        if("y" == str(input("Save this data to file? (y/n) - ")).strip().lower()):  # Double-check with user
            FileProcessor.WriteListDataToFile(objFile,dicRow,lstTable)
